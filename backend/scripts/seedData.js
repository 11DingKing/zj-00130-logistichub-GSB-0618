...
const seedData = () => {
  ...
  try {
    ...
    db.exec(
      "DELETE FROM sqlite_sequence WHERE name IN ('users', 'warehouses', 'locations', 'goods_categories', 'leases', 'inventory_batches', 'inbound_orders', 'inbound_items', 'outbound_orders', 'outbound_items', 'outbound_allocations', 'transactions', 'system_logs')",
    );
    ...
    const users = [
      ...
      },
      {
        ...
        role: "merchant",
        phone: "13900139002",
        email: "wang@speed.com",
        companyName: "速通快递有限公司",
      },
      {
        username: "merchant3",
        name: "陈经理",
    ...
    const warehouses = [
      {
        ...
        description: "普通货物存储区，1-5层",
      },
      {
        code: "WH-B",
        name: "B区恒温仓库",
        address: "园区东区B栋",
        temperatureZone: "constant",
        description: "恒温恒湿仓储区，温度15-25℃",
      },
      {
        code: "WH-C",
        name: "C区冷藏仓库",
    ...
    const leases = [
      ...
      },
      {
        ...
        billingMethod: "monthly",
        unitPrice: 100,
        startDate: moment().subtract(50, "days").format("YYYY-MM-DD"),
        status: "active",
      },
      {
        merchantId: 2,
      ...
      },
      {
        ...
        billingMethod: "per_volume",
        unitPrice: 8,
        startDate: moment().subtract(40, "days").format("YYYY-MM-DD"),
        status: "active",
      },
      {
        merchantId: 2,
        ...
        billingMethod: "per_volume",
        unitPrice: 10,
        startDate: moment().subtract(35, "days").format("YYYY-MM-DD"),
        status: "active",
      },
      {
        merchantId: 3,
      ...
      },
      {
        ...
        billingMethod: "monthly",
        unitPrice: 120,
        startDate: moment().subtract(55, "days").format("YYYY-MM-DD"),
        status: "active",
      },
      {
        merchantId: 4,
      ...
      },
      {
        ...
        categoryId: 10,
        agreedCapacity: 100,
        billingMethod: "per_pallet",
        unitPrice: 50,
        startDate: moment().subtract(65, "days").format("YYYY-MM-DD"),
        status: "active",
      },
      {
        merchantId: 5,
    ...
    leases.forEach((l) => {
      const approvedAt =
        l.status === "active"
          ? moment().subtract(59, "days").format("YYYY-MM-DD HH:mm:ss")
          : null;
    ...
    leases
      ...
      .forEach((l) => {
        const loc = db
          .prepare("SELECT used_capacity FROM locations WHERE id = ?")
          .get(l.locationId);
    ...
    const inventoryBatches = [
      {
        ...
        quantity: 25,
        unit: "袋",
        inboundDate: moment().subtract(55, "days"),
        expiryDate: moment().add(300, "days"),
        status: "normal",
      },
      {
        merchantId: 2,
        ...
        quantity: 20,
        unit: "袋",
        inboundDate: moment().subtract(25, "days"),
        expiryDate: moment().add(330, "days"),
        status: "normal",
      },
      {
        merchantId: 2,
        ...
        quantity: 20,
        unit: "袋",
        inboundDate: moment().subtract(45, "days"),
        expiryDate: moment().add(120, "days"),
        status: "near_expiry",
      },
      {
        merchantId: 2,
        ...
        quantity: 15,
        unit: "袋",
        inboundDate: moment().subtract(20, "days"),
        expiryDate: moment().add(150, "days"),
        status: "normal",
      },
      {
        merchantId: 2,
        ...
        quantity: 40,
        unit: "桶",
        inboundDate: moment().subtract(35, "days"),
        expiryDate: moment().add(500, "days"),
        status: "normal",
      },
      {
        merchantId: 2,
      ...
      },
      {
        ...
        quantity: 35,
        unit: "箱",
        inboundDate: moment().subtract(38, "days"),
        expiryDate: moment().add(45, "days"),
        status: "normal",
      },
      {
        merchantId: 2,
        ...
        quantity: 80,
        unit: "公斤",
        inboundDate: moment().subtract(36, "days"),
      ...
      },
      {
        ...
        quantity: 50,
        unit: "箱",
        inboundDate: moment().subtract(28, "days"),
        expiryDate: moment().add(140, "days"),
        status: "normal",
      },
      {
        merchantId: 2,
        ...
        quantity: 25,
        unit: "箱",
        inboundDate: moment().subtract(100, "days"),
        expiryDate: moment().add(60, "days"),
        status: "slow_moving",
      },
      {
        merchantId: 2,
        ...
        quantity: 45,
        unit: "箱",
        inboundDate: moment().subtract(95, "days"),
        expiryDate: moment().add(250, "days"),
        status: "slow_moving",
      },
      {
        merchantId: 3,
        ...
        quantity: 150,
        unit: "件",
        inboundDate: moment().subtract(37, "days"),
        status: "normal",
      },
      {
        merchantId: 3,
        ...
        quantity: 180,
        unit: "件",
        inboundDate: moment().subtract(39, "days"),
        status: "normal",
      },
      {
        merchantId: 3,
      ...
      },
      {
        ...
        quantity: 40,
        unit: "盒",
        inboundDate: moment().subtract(50, "days"),
        expiryDate: moment().add(650, "days"),
        status: "normal",
      },
      {
        merchantId: 4,
        ...
        quantity: 35,
        unit: "盒",
        inboundDate: moment().subtract(120, "days"),
        expiryDate: moment().add(580, "days"),
        status: "slow_moving",
      },
      {
        merchantId: 4,
      ...
      },
      {
        ...
        quantity: 70,
        unit: "个",
        inboundDate: moment().subtract(40, "days"),
        expiryDate: moment().add(650, "days"),
        status: "normal",
      },
      {
        ...
        quantity: 50,
        unit: "个",
        inboundDate: moment().subtract(110, "days"),
        expiryDate: moment().add(580, "days"),
        status: "slow_moving",
      },
      {
        ...
        quantity: 30,
        unit: "台",
        inboundDate: moment().subtract(30, "days"),
        expiryDate: moment().add(1000, "days"),
        status: "normal",
      },
      {
        merchantId: 5,
      ...
      },
      {
        ...
        unit: "箱",
        inboundDate: moment().subtract(30, "days"),
        expiryDate: moment().subtract(5, "days"),
        status: "expired",
      },
    ];
    ...
    inventoryBatches.forEach((b) => {
      ...
      const prodDate = b.expiryDate
        ? b.expiryDate
            .clone()
            .subtract(categories[b.categoryId - 1].shelfLifeDays, "days")
        : null;
      batchStmt.run(
        batchNo,
        b.merchantId,
    ...
    const batchLeaseMap = {};
    const allBatches = db
      .prepare("SELECT id, lease_id FROM inventory_batches")
      .all();
    allBatches.forEach((b) => {
      batchLeaseMap[b.id] = b.lease_id;
    });
    ...
    const inboundOrders = [
      {
        ...
        warehouseId: 1,
        status: "completed",
        arrivalDate: moment().subtract(55, "days"),
        contactPerson: "张收货",
      ...
      },
      {
        ...
        warehouseId: 1,
        status: "completed",
        arrivalDate: moment().subtract(45, "days"),
        contactPerson: "张收货",
        contactPhone: "13800138001",
        totalQty: 35,
      },
      {
        ...
        warehouseId: 3,
        status: "completed",
        arrivalDate: moment().subtract(40, "days"),
        contactPerson: "张收货",
        contactPhone: "13800138001",
        totalQty: 80,
      },
      {
        ...
        warehouseId: 1,
        status: "completed",
        arrivalDate: moment().subtract(3, "days"),
        contactPerson: "李快递",
      ...
      },
      {
        ...
        warehouseId: 1,
        status: "completed",
        arrivalDate: moment().subtract(50, "days"),
        contactPerson: "王医药",
    ...
    inboundOrders.forEach((order, idx) => {
      ...
      const checkedBy = ["completed", "checking"].includes(order.status)
        ? 1
        : null;
      const checkedAt = ["completed", "checking"].includes(order.status)
        ? order.arrivalDate
            .clone()
            .add(2, "hours")
      ...
      const orderId = inboundOrderStmt.run(
        ...
        order.totalQty,
        order.status,
        order.arrivalDate.format("YYYY-MM-DD"),
        order.contactPerson,
        order.contactPhone,
        checkedBy,
        checkedAt,
      ...
      if (idx === 0) {
        inboundItemStmt.run(
          orderId,
          1,
          generateBatchNo(order.arrivalDate),
          25,
          25,
          "袋",
          null,
        ...
        if (order.status === "completed") {
          txnStmt.run(
            ...
            1,
            "入库大米25袋",
            order.arrivalDate.format("YYYY-MM-DD HH:mm:ss"),
          );
        }
      } else if (idx === 1) {
        inboundItemStmt.run(
        ...
        inboundItemStmt.run(
          orderId,
          1,
          generateBatchNo(order.arrivalDate.clone().add(30, "days")),
          15,
          15,
          "袋",
          null,
          moment().add(330, "days").format("YYYY-MM-DD"),
          1,
          "completed",
          completedAt,
        );
        ...
        inboundItemStmt.run(
          orderId,
          3,
          generateBatchNo(moment()),
          40,
          40,
          "桶",
          null,
          moment().add(500, "days").format("YYYY-MM-DD"),
          null,
          "putaway",
          null,
        );
    ...
    const outboundOrders = [
      {
        ...
        warehouseId: 1,
        status: "completed",
        deliveryDate: moment().subtract(40, "days"),
        contactPerson: "刘客户",
      ...
      },
      {
        ...
        warehouseId: 1,
        status: "completed",
        deliveryDate: moment().subtract(20, "days"),
        contactPerson: "王客户",
      ...
      },
      {
        ...
        warehouseId: 1,
        status: "completed",
        deliveryDate: moment().subtract(2, "days"),
        contactPerson: "赵收件",
      ...
      },
      {
        ...
        warehouseId: 2,
        status: "completed",
        deliveryDate: moment().subtract(10, "days"),
        contactPerson: "孙买家",
    ...
    outboundOrders.forEach((order, idx) => {
      ...
      const pickedBy = ["completed", "picking"].includes(order.status)
        ? 1
        : null;
      const pickedAt = ["completed", "picking"].includes(order.status)
        ? order.deliveryDate
            .clone()
            .subtract(1, "day")
            .format("YYYY-MM-DD HH:mm:ss")
      ...
      const orderId = outboundOrderStmt.run(
        ...
        order.totalQty,
        order.status,
        order.deliveryDate.format("YYYY-MM-DD"),
        order.contactPerson,
        order.contactPhone,
        order.destination,
        pickedBy,
      ...
      const itemId = outboundItemStmt.run(
        orderId,
        categoryId,
        order.totalQty,
        order.status === "pending" ? 0 : order.totalQty,
        unit,
        itemStatus,
        null,
      ).lastInsertRowid;
      ...
      if (order.status !== "pending") {
        ...
        outboundAllocStmt.run(
          itemId,
          batchId,
          order.totalQty,
          order.status === "completed" ? order.totalQty : 0,
        );
        ...
        if (order.status === "completed") {
          txnStmt.run(
            ...
            order.merchantId,
            order.warehouseId,
            [1, 2, 10, 54, 49, 10][idx] || 1,
            categoryId,
            batchId,
            batchLeaseMap[batchId] || null,
            order.totalQty,
            unit,
            1,
    ...
    recentTxns.forEach((t) => {
      const refNo =
        t.type === "inbound"
          ? "IN" + t.date.format("YYYYMMDD") + "001"
          : t.type === "outbound"
            ? "OUT" + t.date.format("YYYYMMDD") + "001"
            : t.type === "transfer"
              ? "TR" + t.date.format("YYYYMMDD") + "001"
      ...
      txnStmt.run(
        ...
        t.categoryId,
        t.batchId || null,
        t.batchId ? batchLeaseMap[t.batchId] || null : null,
        t.qty,
        t.unit,
        1,
        `${t.type === "inbound" ? "入库" : t.type === "outbound" ? "出库" : t.type === "transfer" ? "移库" : "调整"}${categories[t.categoryId - 1].name}${t.qty}${t.unit}`,
    ...
    const priceTiers10 = JSON.stringify([
      { min_usage: 0, max_usage: 100, unit_price: 50 },
      { min_usage: 100, max_usage: 500, unit_price: 45 },
      { min_usage: 500, max_usage: null, unit_price: 40 },
    ]);
    db.prepare("UPDATE leases SET price_tiers = ? WHERE id = 10").run(
      priceTiers10,
    );
    console.log("✅ 为租约10(按托盘/恒信电子/手机电池)配置阶梯价格");
