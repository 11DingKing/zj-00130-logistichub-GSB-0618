...
router.get("/disputes", authenticateToken, billController.getDisputes);
router.get("/disputes/:id", authenticateToken, billController.getDisputeById);
